                            ...
                            <?php if (hasPermission("Purchases")) : ?>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="<?php echo base_url(); ?>view/viewDeliveryNotes">View Delivery Notes</a></li>
                                        <li><a href="<?php echo base_url(); ?>view/viewAllocations">View Pending Allocations</a></li>
                                    </ul>
                                </li>
                            <?php endif; ?>
                            <?php if (hasPermission("Customers")) : ?>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="<?php echo base_url(); ?>view/viewPrices">Customer Prices</a></li>
                                    </ul>
                                </li>
                            <?php endif; ?>
