            ...
            if ($allDeliveryNotess):
                foreach ($allDeliveryNotess as $bill):
                    ...
                    <tr class="pgx-success">
                        ...
                        <td><?php
                            $dt = new DateTime($bill->date, new DateTimeZone("Asia/Colombo"));
                            echo $dt->format('d.m.Y, H:i:s');
                            ?></td>
                        <td>
                            <a class="btn btn-primary btn-xs" role="button"
                               href="<?php echo base_url(); ?>view/printDeliveryNote/<?php echo urlencode(base64_encode($bill->id)); ?>">Re-Print</a>
