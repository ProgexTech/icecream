...
class View extends CI_Controller {
    ...
    public function viewStock($storeType = NULL) {
    ...
    public function addDriver($customerId) {
        $this->load->model('customer_model');
        $data['customerId'] = $customerId;
        $data['main_content'] = "customer/add_customer_driver";
        $this->load->view("layouts/main", $data);
    }
    ...
    public function printDeliveryNote2($billId) {
        $this->load->model('purchaseOrder_model');
        $this->load->model('customer_model');
        $this->load->model('sale_model');
        $this->load->model('stock_model');
        ...
        $data['billId'] = $billId;
        $data['main_content'] = "po/print_delivery_note2";
        $this->load->view("layouts/main", $data);
    }
